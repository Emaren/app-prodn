...
export const WATCHER_RELEASE = {
  version: "1.5.1",
  label: "AoE2HDBets Watcher 1.5.1",
  releasedOn: "Jul 7, 2026",
  signingStatus: "Signed Windows 1.5.1 builds; macOS and Linux 1.5.1 builds available",
  featureChips: [
    "AoE2HDBets Watcher 1.5.1",
    "Jul 7, 2026",
    "Windows installer",
...
export const WATCHER_DOWNLOAD_ARTIFACTS: readonly WatcherDownloadArtifact[] = [
  {
    ...
    badge: "Recommended",
    filename: "AoE2HDBets Watcher Setup 1.5.1.exe",
    format: "NSIS",
    description:
      "Smoothest Windows path. Installs cleanly, creates shortcuts, and includes the new batch replay scan diagnostics.",
    downloadPath: "/downloads/AoE2HDBets%20Watcher%20Setup%201.5.1.exe",
  ...
  },
  {
    ...
    badge: "Fallback",
    filename: "AoE2HDBets Watcher 1.5.1.exe",
    format: "portable",
    description:
      "Same Windows 1.5.1 watcher core in a no-installer package if installer policy gets in the way.",
    downloadPath: "/downloads/AoE2HDBets%20Watcher%201.5.1.exe",
  ...
  },
  {
    ...
    badge: "Mac first",
    filename: "AoE2HDBets Watcher-1.5.1-arm64.dmg",
    format: "DMG",
    description:
      "Best Mac install path. Drag in, pair once, and keep it open while AoE2HD runs under macOS or CrossOver.",
    downloadPath: "/downloads/AoE2HDBets%20Watcher-1.5.1-arm64.dmg",
  ...
  },
  {
    ...
    format: "ZIP",
    description:
      "Same macOS 1.5.1 app bundle, packaged as a direct ZIP for users who hit DMG or Gatekeeper friction.",
  ...
  },
  {
    ...
    badge: "Linux",
    filename: "AoE2HDBets Watcher-1.5.1.AppImage",
    format: "AppImage",
    description:
      "Portable Linux 1.5.1 watcher for Proton or Wine-heavy setups where manual replay-folder selection matters most.",
    downloadPath: "/downloads/AoE2HDBets%20Watcher-1.5.1.AppImage",
