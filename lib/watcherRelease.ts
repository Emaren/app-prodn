...
export const WATCHER_DOWNLOAD_ARTIFACTS: readonly WatcherDownloadArtifact[] = [
  {
    ...
    badge: "Recommended",
    filename: "AoE2HDBets Watcher Setup 1.5.7.exe",
    format: "NSIS",
    description:
      "Smoothest Windows path. Installs cleanly, creates shortcuts, and keeps the first run obvious.",
    downloadPath: "/downloads/AoE2HDBets%20Watcher%20Setup%201.5.7.exe",
  ...
  },
  {
    ...
    badge: "Mac first",
    filename: "AoE2HDBets Watcher-1.5.7-arm64.dmg",
    format: "DMG",
    description:
      "Best Mac install path. Drag in, pair once, and keep it open while AoE2HD runs under macOS or CrossOver.",
    downloadPath: "/downloads/AoE2HDBets%20Watcher-1.5.7-arm64.dmg",
