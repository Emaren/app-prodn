...
export const WATCHER_DOWNLOAD_ARTIFACTS: readonly WatcherDownloadArtifact[] = [
  {
    ...
    badge: "Recommended",
    filename: "AoE2HDBets Watcher Setup 1.5.11.exe",
    format: "NSIS",
    description:
      "Smoothest Windows path. Installs cleanly, creates shortcuts, and keeps the first run obvious.",
    downloadPath: "/downloads/AoE2HDBets%20Watcher%20Setup%201.5.11.exe",
  ...
  },
  {
    ...
    badge: "Fallback",
    filename: "AoE2HDBets Watcher 1.5.11.exe",
    format: "portable",
    description:
      "Same signed Windows watcher core in a no-installer package if installer policy gets in the way.",
    downloadPath: "/downloads/AoE2HDBets%20Watcher%201.5.11.exe",
  ...
  },
  {
    ...
    badge: "Mac first",
    filename: "AoE2HDBets Watcher-1.5.11-arm64.dmg",
    format: "DMG",
    description:
      "Best Mac install path. Drag in, pair once, and keep it open while AoE2HD runs under macOS or CrossOver.",
    downloadPath: "/downloads/AoE2HDBets%20Watcher-1.5.11-arm64.dmg",
