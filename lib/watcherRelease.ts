...
export const WATCHER_RELEASE = {
  version: "1.3.0",
  label: "AoE2HDBets Watcher 1.3.0",
  releasedOn: "Jun 12, 2026",
  signingStatus: "Signed Windows builds; unsigned macOS builds",
  featureChips: [
    "AoE2HDBets Watcher 1.3.0",
    "Jun 12, 2026",
    "Windows installer",
...
export const WATCHER_DOWNLOAD_ARTIFACTS: readonly WatcherDownloadArtifact[] = [
  {
    ...
    badge: "Recommended",
    filename: "AoE2HDBets Watcher Setup 1.3.0.exe",
    format: "NSIS",
    description:
      "Smoothest Windows path. Installs cleanly, creates shortcuts, and keeps the first run obvious.",
    downloadPath: "/downloads/AoE2HDBets%20Watcher%20Setup%201.3.0.exe",
  ...
  },
  {
    ...
    badge: "Mac first",
    filename: "AoE2HDBets Watcher-1.3.0-arm64.dmg",
    format: "DMG",
    description:
      "Best Mac install path. Drag in, pair once, and keep it open while AoE2HD runs under macOS or CrossOver.",
    downloadPath: "/downloads/AoE2HDBets%20Watcher-1.3.0-arm64.dmg",
