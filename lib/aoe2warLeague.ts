...
export const kingdomChronicles: KingdomChronicle[] = [
  {
    ...
    label: "Chronicle I",
    title: "The Founding",
    body: "Genesis transactions. Treasury, Bounty Reserve, Liquidity Reserve, Mainnet Live. The Kingdom exists before the people arrive.",
  ...
  },
  {
    ...
    body: "Julio entered the line with hello there and immediately gave useful field feedback. The first real scout had answered.",
  ...
  },
  {
    ...
    body: "Sniper made contact with yo and gave the project early champion energy. The top warrior had seen the field.",
  ...
  },
  {
    ...
    body: "Pigman answered the call. You are number 3 to make contact.",
  ...
  {
    id: "guardian-summoned",
    label: "Chronicle V",
    title: "The Guardian Is Summoned",
    body: "Jim was invited into the wallet path: Keplr, WOLO, and the first bridge into the Kingdom ledger.",
  ...
  },
  {
    id: "guardian-answers",
    label: "Chronicle VI",
    title: "The Guardian Answers",
    body: "Jim answered ready to set things up. The future USA Champion entered the command line.",
  ...
  },
  {
    ...
    body: "Dil_Pascana appeared in the roster, but never made direct contact. The Kingdom records the difference between presence and voice.",
  ...
  },
  {
    ...
    body: "Ra made contact with hey Emaren. A real voice crossed the line from the eastern edge of the map.",
  ...
  },
  {
    ...
    body: "Sniper reached the top of the field. Rank #1 became part of the Kingdom story.",
  ...
  },
  {
    ...
    body: "Jim, Sniper, and Julio received the first mainnet WOLO. The promise started becoming ledger.",
  ...
  },
  {
    ...
    body: "Founding signup promise paid into the early kingdom ledger.",
    dateLabel: "Jun 7, 2026",
    kind: "transaction",
    amountWolo: 100000,
    actor: "Jim",
  ...
  },
  {
    ...
    label: "Chronicle XIV",
    title: "The Watcher Package Pulls",
    body: "The Windows installer pull was matched to watcher-submitted game stats. The machine began turning files into proof.",
  ...
  },
  {
    id: "old-files-awaken",
    label: "Chronicle XV",
    title: "The Old Files Awaken",
    body: "Jim proved old saved games could be found and uploaded fast. The archives started becoming Kingdom data.",
  ...
  },
  {
    ...
    body: "Thirteen arrived. The USA Champion was no longer just a name in the line — he showed up for war.",
  ...
  },
  {
    ...
    body: "The first long-form Kingdom dispatch is written. The chronicle becomes more than a ledger.",
  ...
  },
  {
    ...
    body: "Zodiac is selected leader of the clan. The Kingdom starts forming offices, not just users.",
  ...
  },
  {
    ...
    body: "The AI Scribe and Grimer become part of the command room. Memory, counsel, and darker colour enter the line.",
  ...
  },
  {
    ...
    body: "1M WOLO to Jim for proving old war files can be uploaded and parsed at the click of a button. This Kingdom runs on AoE2WAR data. This is not a game. This is War.",
  ...
  },
  {
    ...
    body: "1M WOLO to Jim for bringing the old wars back to the fire. 1,993 other ways to die — the Kingdom is now stronger than ever.",
    dateLabel: "Jul 8, 2026",
    kind: "bounty",
    amountWolo: 1000000,
    actor: "Jim",
