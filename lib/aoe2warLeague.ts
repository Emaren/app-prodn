...
export const kingdomChronicles: KingdomChronicle[] = [
  ...
  },
  {
    id: "first-horn",
    label: "Chronicle II",
    title: "The First Horn",
    body: "The first private line was opened to [BDB]Pigman. The call went out before the realm had walls.",
  ...
  },
  {
    ...
    title: "The Eastern Beacons",
    body: "Dil_Pascana and Ra joined. The first international cluster formed across the realm.",
