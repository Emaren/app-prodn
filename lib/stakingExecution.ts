...
export const STAKING_REWARD_DISTRIBUTION_SAFETY_PAUSED = false;
export const STAKING_REWARD_DISTRIBUTION_SAFETY_DETAIL =
  "Staking reward distribution is available through the chain-backed custody rail; auto-compound liability increases only after exact WoloChain custody proof.";
