...
export default function WorkshopChronicleClassic({
  initialEntries,
  initialHasMore,
  initialNextCursor,
}: Props) {
  ...
  return (
    <section
      id="chronicle"
      data-chronicle-layout="side-by-side"
...
function ClassicEntry({
  ...
  return (
    <article
      id={entry.publicId}
      className={[
        "relative grid scroll-mt-28 sm:grid-cols-2",
    ...
    >
      ...
      >
        ...
        >
          ...
          {major && entry.body ? (
            <p className="mt-4 whitespace-pre-wrap text-sm leading-7 text-slate-400 [overflow-wrap:anywhere]">
              {entry.body}
            </p>
          ) : null}
