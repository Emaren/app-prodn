  ...
  return (
    <>
      <section className="relative overflow-hidden rounded-[2.35rem] border border-amber-100/14 bg-[radial-gradient(circle_at_16%_0%,rgba(251,146,60,0.22),transparent_31%),radial-gradient(circle_at_83%_8%,rgba(34,211,238,0.13),transparent_29%),linear-gradient(145deg,#1a0d08,#07111b_54%,#04070c)] px-6 py-9 shadow-[0_30px_120px_rgba(0,0,0,0.34)] sm:px-11 sm:py-12">
        ...
        <div className="mt-6 text-xs font-bold uppercase tracking-[0.42em] text-orange-100/55">
          AoE2WAR · Live Build Culture
        </div>
        <h1 className="mt-4 max-w-4xl font-serif text-5xl leading-[0.96] sm:text-7xl">
          The strange machine is forged in public.
        </h1>
        <p className="mt-5 max-w-3xl text-sm leading-7 text-slate-300 sm:text-base">
          Follow what changed, what the evidence proves, what still needs work,
          and which gates keep replay truth separate from money and settlement.
        </p>
        <CurrentFront data={data} />
        <div className="mt-7 flex flex-wrap gap-3">
          <Link href="#workbench" className="inline-flex min-h-11 items-center gap-2 rounded-full bg-amber-200 px-5 text-sm font-bold text-slate-950 hover:bg-amber-100">
            <Hammer className="h-4 w-4" /> Enter the forge
          </Link>
          <Link href="/radio" className="inline-flex min-h-11 items-center gap-2 rounded-full border border-fuchsia-100/18 bg-fuchsia-300/[0.06] px-5 text-sm font-semibold text-fuchsia-50 hover:bg-fuchsia-300/10">
            <Radio className="h-4 w-4" /> Workshop Radio
          </Link>
        </div>
      </section>
...
function ExtremeView(props: ViewProps) {
  ...
  return (
    <>
      <section className="relative overflow-hidden rounded-[2.65rem] border border-white/10 bg-[#020711] p-6 shadow-[0_42px_140px_rgba(0,0,0,0.62)] sm:p-9 lg:p-11">
