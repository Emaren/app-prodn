...
## Homepage natural board flow — 2026-07-09

- Leaderboard and War Chest no longer render as nested internal scroll panes on the homepage.
- The homepage page scroll owns the movement, preventing trapped scroll, bounce-back, and height flicker.
- The data remains seeded generously: Leaderboard starts with 600 rows and can continue through the paged API; War Chest receives the full current board.
