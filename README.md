...
- `/market` is the player-built AoE2WAR Agora, launching with The Visage Forge, authenticated $100 USD avatar commission scrolls, direct operator-inbox requests, profile avatar-vault delivery, and an open-shop proposal rail
