...
- `/market` is the player-built AoE2WAR Agora, launching with The Visage Forge, authenticated 100 WOLO avatar commission scrolls, direct operator-inbox requests, profile avatar-vault delivery, and an open-shop proposal rail
