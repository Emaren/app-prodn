...
- `/forum` is the persistent War Room: Basic is the focused compact index and single-column reading experience; Advanced is the wider default with Wolo Chronicles, room signals, excerpts, editorial thread pages, and useful context rails; Extreme is a distinct full-width unfolded edition with visible lead copy, dispatch wire, feature blocks, an illustrated middle, and newspaper-style thread pages
