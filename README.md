...
- `/market` is the player-built AoE2WAR Agora, launching with The Visage Forge, an AoE2-lobby-inspired dark commission desk, authenticated 100 WOLO avatar requests, direct operator-inbox delivery, profile avatar-vault delivery, and an open-shop proposal rail
