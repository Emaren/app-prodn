...
ALTER TABLE "staking_reward_distributions"
  ADD COLUMN IF NOT EXISTS "betting_fee_pool_uwolo" BIGINT NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS "staker_pool_uwolo" BIGINT NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS "treasury_pool_uwolo" BIGINT NOT NULL DEFAULT 0;
