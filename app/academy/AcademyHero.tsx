    ...
    >
      ...
      <div className="relative flex min-h-[38rem] flex-col px-6 py-10 sm:min-h-[43rem] sm:px-10 lg:min-h-[46rem] lg:px-14">
        ...
        <div className="mt-auto max-w-[42rem] pb-2">
          ...
          <div className="mt-4 h-px w-56 bg-gradient-to-r from-amber-200/34 via-amber-100/10 to-transparent" />

          <p className="mt-5 max-w-[34rem] text-base font-medium leading-7 text-slate-200/56 sm:text-lg">
            Read the field. Move with intent. Raise your ELO.
          </p>

          <p className="mt-3 max-w-[37rem] text-sm leading-6 text-slate-400/50">
          ...
          <div className="mt-7 flex flex-col gap-3 sm:flex-row">
            <Link
              href="#advisors"
              className="group inline-flex min-h-11 items-center justify-center gap-2 rounded-full border border-white/[0.065] bg-[linear-gradient(135deg,rgba(92,64,18,0.16),rgba(3,7,18,0.58))] px-5 py-2.5 text-xs font-semibold text-slate-200/66 shadow-[0_14px_34px_rgba(0,0,0,0.26)] backdrop-blur-xl transition hover:-translate-y-0.5 hover:border-amber-100/22 hover:bg-amber-100/[0.045]"
            >
              Meet the advisors
              <ArrowRight className="h-3.5 w-3.5 text-amber-100/34 transition group-hover:translate-x-1" />
            </Link>
            <Link
              href="/zodiac"
              className="inline-flex min-h-10 items-center justify-center gap-2 rounded-full border border-white/[0.075] bg-black/24 px-5 py-2.5 text-xs font-semibold text-slate-300/54 backdrop-blur-md transition hover:-translate-y-0.5 hover:border-violet-100/18 hover:bg-violet-300/[0.045] hover:text-slate-200/86"
            >
              Train under the Zodiac
              <Sparkles className="h-3.5 w-3.5 text-violet-200/34" />
            </Link>
          </div>
        </div>

        <div className="absolute bottom-6 right-6 hidden grid-cols-3 overflow-hidden rounded-[1.1rem] border border-white/[0.075] bg-black/18 text-left shadow-[0_18px_46px_rgba(0,0,0,0.28)] backdrop-blur-md lg:grid">
          <div className="border-r border-white/[0.06] px-4 py-3">
            <div className="text-[9px] font-bold uppercase tracking-[0.24em] text-slate-500/48">
              Doctrine
            </div>
            <div className="mt-1 text-sm font-bold text-slate-200/66">
              Field reads
            </div>
          </div>
          <div className="border-r border-white/[0.06] px-4 py-3">
