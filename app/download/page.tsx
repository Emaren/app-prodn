    ...
    >
      {extreme ? (
        <section
          ...
          aria-label="AoE2HDBets Watcher 1.5.6"
        >
          ...
          <p className="sr-only">
            AoE2HDBets Watcher 1.5.6 automatically captures live and historical
          ...
          <picture>
            ...
            <img
              ...
              alt="AoE2WAR Watcher 1.5.6 replay companion overview"
              width="1672"
              height="941"
              loading="eager"
              fetchPriority="high"
