...
function ReplayVaultReleaseStamp() {
  return (
    <aside className="mx-auto mt-10 w-full max-w-3xl text-right">
...
export default function UploadReplay() {
  ...
  if (!isAuthenticated) {
    return (
      <div className="mx-auto flex min-h-[calc(100vh-5rem)] w-full max-w-5xl flex-col justify-start px-4 pt-24 pb-44 text-white md:pt-28 md:pb-52">
