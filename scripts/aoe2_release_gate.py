...
def path_risk(path: str) -> str:
    ...
    infra_exact = {
        ...
        "tests/test_aoe2_db_snapshot_retention.py",
        "tests/test_aoe2_storage_campaign.py",
        "tests/test_aoe2_storage_handoff.py",
...
def command_plan(
    ...
    *,
    ...
    if risk not in {"NO_CHANGE", "DOCUMENTATION"} or same_source_recertification:
        commands.append(
            ("active-python-test-contract", ["python3", "scripts/run_python_contract.py"], 420)
        )
