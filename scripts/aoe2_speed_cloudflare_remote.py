...
DYNAMIC_ALLOWED_ROUTES = ("/academy", "/ai", "/battle-archive", "/bounties", "/champions", "/champions/world", "/clans", "/leaderboard/og", "/national-champions", "/players", "/players/by-name/Emaren")
