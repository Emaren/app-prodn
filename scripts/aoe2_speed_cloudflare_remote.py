...
DYNAMIC_ALLOWED_ROUTES = ("/academy", "/ai", "/battle-archive", "/bounties", "/champions", "/champions/world", "/clans", "/forum", "/leaderboard/og", "/market", "/market/shops/chat-effects", "/national-champions", "/players/by-name/Emaren")
